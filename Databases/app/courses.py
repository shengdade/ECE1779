...
def courses_edit(id):
    ...
    return render_template("courses/edit.html", title="Edit Course", id=id, code=code, ctitle=title,
...
def courses_edit_save(id):
    ...
    if error:
        return render_template("courses/edit.html", title="New Course", error_msg=error_msg, id=id, code=code,
                               ctitle=title, description=description)
